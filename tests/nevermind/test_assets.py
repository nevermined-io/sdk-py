...
def test_register_asset(publisher_instance, ddo_sample):
    ...
    # ensure Nevermind token balance
...
def test_create_data_asset(publisher_instance, consumer_instance, ddo_sample):
    """
    Setup accounts and asset, register this asset on Nevermind Metadata.
    """
...
def test_ocean_execute_workflow(publisher_instance, consumer_instance):
    ...
    assert workflow_ddo
    metadata = get_computing_metadata()
    ddo_computing = publisher_instance.assets.create(metadata, publisher)

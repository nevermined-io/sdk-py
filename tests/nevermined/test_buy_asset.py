...
def test_buy_asset(publisher_instance_no_init, consumer_instance_no_init):
    ...
    assert consumer_instance_no_init.assets.consume(
        agreement_id,
        ddo.did,
        sa.index,
        consumer_account,
    ...
    with pytest.raises(AssertionError):
        consumer_instance_no_init.assets.consume(
            agreement_id,
            ddo.did,
            sa.index,
            consumer_account,
...
#
#     # Register ddo
#     ddo = get_registered_with_psk(publisher_instance_gateway, pub_acc)
#     assert isinstance(ddo, DDO)
#     # nevermined here will be used only to publish the asset. Handling the asset by the publisher
#     # will be performed by the Gateway server running locally
#
...
#         agreement_id, sa.get_price(), pub_acc)
#
#     assert consumer_instance_gateway.assets.consume(
#         agreement_id,
#         ddo.did,
#         sa.index,
#         consumer_account,
...
#
#     with pytest.raises(AssertionError):
#         consumer_instance_gateway.assets.consume(
#             agreement_id,
#             ddo.did,
#             sa.index,
#             consumer_account,
